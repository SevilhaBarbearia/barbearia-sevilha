...
export async function entrarAdministrador(_state: { erro: string }, formData: FormData) {
  ...
  try {
    ...
    if (error) return { erro: 'Não foi possível entrar. Confira suas credenciais e tente novamente.' };
