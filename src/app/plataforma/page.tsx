...
export default async function PlatformPage() {
  ...
  /*
   * Esta tela ainda é o esqueleto existente.
   * O dashboard completo será construído no próximo pacote.
   *
   * A leitura comercial é permitida ao Platform Admin pela RLS.
   */
  const { data } =
    await supabase
      .from("barbershops")
      ...
      <div className="mx-auto grid max-w-5xl gap-4">
        ...
        <Card>
          ...
          <CardDescription>
            ...
            Supabase Auth. Novos tenants recebem trial de 15 dias. Trials já
