...
export default async function AdminLoginPage() {
  if (await obterAdministradorAtual()) redirect("/admin/selecionar");
  return (
    <main className="fundo-premium grid min-h-screen place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <Card className="mt-8">
          ...
          <CardDescription>
            Entre com a conta administrativa para acompanhar reservas, agenda e
            pagamentos.
          </CardDescription>
          <AdminLoginForm />
        </Card>
        ...
        >
          É cliente? Acesse seus agendamentos
        </Link>
      </div>
    </main>
  );
