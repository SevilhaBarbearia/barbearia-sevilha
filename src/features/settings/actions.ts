...
import { calcularForegroundSeguro } from "@/lib/theme/paleta-marca";

const secureMediaUrl = z.union([
  z.literal(""),
  z
    .string()
    .trim()
    ...
    .refine(
      ...
      "Use uma URL HTTPS válida e sem credenciais.",
    ),
]);
...
export async function updateBusinessSettings(
  ...
  revalidatePath(
    `/admin/${barbershop.slug}/configuracoes`,
  );
...
export async function updateNotificationSettings(
  ...
  if (
    ...
    return {
      ok: false,
      mensagem:
        "Revise o horário e os textos das mensagens.",
    };
  }
  ...
  if (
    ...
    return {
      ok: false,
      mensagem:
        "Não foi possível salvar os textos. Tente novamente.",
    };
  }
